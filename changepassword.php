...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if(trim($_POST['password'] == trim($_POST['confirmpassword']))){
        ...
        if (empty(trim($_POST['password']))) {
            ...
            $err = "Password should be more than 5 charaters";
        }
        else {
            $hashed_password = mysqli_query($conn,"SELECT `password`FROM `users` WHERE `email`='".$email."'");
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="" method="post">
                    ...
                    <?php
                    if($err){
                      echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">'.$err.'<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                    }
                    else if($success){
                      echo '
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">Password Updated Successfully <button type="button" name="close_alert"  class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                    }
                    ?>
