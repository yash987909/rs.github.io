...
if (isset($_POST['send_email'])) {
  ...
  // check if the entered email is in the array
  $entered_email = $email;
  if (in_array($entered_email, $email_array)) {
    ...
    if (mysqli_stmt_execute($stmt)) {
      ...
      if (mysqli_stmt_num_rows($stmt) == 1) {
        ...
        if (mysqli_stmt_fetch($stmt)) {
          ...
          $mail->Username = 'fakeyashyadav@gmail.com'; // SMTP username
          $mail->Password = 'txobhoevftpevtlz'; // SMTP password
          $mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
          $mail->Port = 587; // TCP port to connect to

          $mail->setFrom('fakeyashyadav@gmail.com', 'RS');
          $mail->addAddress($email); // Add a recipient


          $mail->isHTML(true); // Set email format to HTML

          $mail->Subject = 'Forgot Password New Password';
          $mail->Body = 'Your New password is  <b>' . $randomString . '</b> . Login with this password now. To login <a href="login.php">Click Here</a>';
      ...
      $err = "Wrong Email Please Try again";
    }
  }
}
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" name="send_email" type="submit">Send Email</button>
                    </div>
